...
-- AddForeignKey
ALTER TABLE `Article` ADD CONSTRAINT `Article_idMembre_fkey` FOREIGN KEY (`idMembre`) REFERENCES `Membre`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Article` ADD CONSTRAINT `Article_idRubriques_fkey` FOREIGN KEY (`idRubriques`) REFERENCES `Rubrique`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
